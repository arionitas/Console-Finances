var finances = [           // Arrays composing of Date and Profit/Losses //
  ['Jan-2010', 867884],
  ['Feb-2010', 984655],
  ['Mar-2010', 322013],
  ['Apr-2010', -69417],
...
const endDate = new Date(2017, 3);

const monthDiff = endDate.getMonth() - startDate.getMonth() +
(12 * (endDate.getFullYear() - startDate.getFullYear()));
console.log('Total Months', monthDiff); // Calculating  the total amount of months
...
earningsArray.reduce((accVal, curVal) => accVal + curVal,0) / data.length;  // Receiving the average of all total and losses
